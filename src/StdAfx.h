...
#if UNDER_CE < 400
//Use stlport
#pragma warning (disable:4284) //Stlport generates lots of these!
#include "\stlport\stlport\stl\_string.h"
#endif
#endif
...
#include <windows.h>
#include <winuser.h>
#include <commctrl.h> //Slider, SpinControl etc.
...
#define WMET_APP_TITLE _T("Open Metronome ")
//{{AFX_INSERT_LOCATION}}
